//
//  BottomSheetModifierWithScrollView.swift
//  BottomSheetModifier
//
...
struct BottomSheetModifierWithScrollView<SheetContent: View>: ViewModifier {
    ...
    init(isPresented: Binding<Bool>,
         ...
         showLines: Bool = true,
         canCloseAtScrollTop: Binding<Bool>,
         @ViewBuilder sheetContent: @escaping () -> SheetContent) {
        self._isPresented = isPresented
        self._canCloseAtScrollTop = canCloseAtScrollTop
        self.height = height
        self.title = title
    ...
    private var bottomSheetView: some View {
        ...
        .onChange(of: canCloseAtScrollTop) { newValue in
            if newValue { closeSheet() }
        }
    }
...
//MARK: VIEW EXTENSION
extension View {
    func bottomSheetWithScrollView<SheetContent: View>(
        ...
        self.modifier(BottomSheetModifierWithScrollView(
